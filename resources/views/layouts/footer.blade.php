...
<footer class="page-footer font-small unique-color-dark">
    ...
    <div style="background-color: #e0e4cc;">
      <div class="container">
...
<div class="bak"  style="background-color: rgb(26, 26, 26)">
    <!-- Footer Links -->
    ...
    <!-- Copyright -->
    <div class="footer-copyright text-center py-3" style="color: rgb(224, 224, 224)">© 2020 Copyright By:
      <h4 style="color: rgb(141, 92, 36)">IrfanHarfiansyah <i class="fas fa-heart" style="color: rgb(128, 48, 48)"></i></h4>
    </div>
    <!-- Copyright -->
</div>
  </footer>
